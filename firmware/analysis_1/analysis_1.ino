...
void setup() {
    ...
    X.registerToCommandManager(cmdMgr, "a1d"); 
    Y.registerToCommandManager(cmdMgr, "hpH");
    Z.registerToCommandManager(cmdMgr, "vpH");
    E0.registerToCommandManager(cmdMgr, "hcond"); 
    E1.registerToCommandManager(cmdMgr, "vcond"); 
